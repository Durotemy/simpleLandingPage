...
// const Hero = () => {
//   return (
//     <div className="w-full h-screen bg-zinc-200 flex flex-col justify-content">
//       <div className="grid md:grid-cols-2 md:text-green-700 max-w-[1240px] m-auto">
...
//         </div>
//         <div className="flex flex-col align-items justify-content py-8 md:min-w-[768px] bottom-[5%]mx-1 md:left-1/2 transform md:-translate-x-1/2 bg-zinc-200 border border-slate-300 rounded-xl text-center shadow-xl">
...
//             </p>
//             <p className="flex px-4 py-2">
//               <PaperAirplaneIcon className="h-6 text-indigo-600" />Cloud Data
//             </p>
//             <p className="flex px-4 py-2">
